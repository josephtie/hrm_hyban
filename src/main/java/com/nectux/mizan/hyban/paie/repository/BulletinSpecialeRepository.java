...
public interface BulletinSpecialeRepository extends CrudRepository<BulletinSpeciale, Long> {
	...
	public List<BulletinSpeciale> findAll();
	...
	public List<BulletinSpeciale> findByPeriodePaieId(Long idptret);


	
	public List<BulletinSpeciale> findBySpecialContractEmployeeIdAndPeriodePaieId(Long idpers,Long idperiode);
