...
public class PersonnelRequest {
    ...
    private Integer ancienneteInitial;
    ...
    public String getNumeroGuichet() { return numeroGuichet; }
    public void setNumeroGuichet(String numeroGuichet) { this.numeroGuichet = numeroGuichet; }
    ...
    public Integer getAncienneteInitial() { return ancienneteInitial; }
    public void setAncienneteInitial(Integer ancienneteInitial) { this.ancienneteInitial = ancienneteInitial; }
    public Boolean getCarec() { return carec; }
    public void setCarec(Boolean carec) { this.carec = carec; }
    public String getTypeEmp() { return typeEmp; }
    public void setTypeEmp(String typeEmp) { this.typeEmp = typeEmp; }
