...
//	@PostMapping(value = "/listpersonneljson")
//	public @ResponseBody PersonnelDTO getPersonnelListJSON(@RequestBody PaginationRequest req, Principal principal) {
//
//		Integer offset = req.getOffset() == null ? 0 : req.getOffset();
//		Integer limit = req.getLimit() == null ? 10 : req.getLimit();
//		String search = req.getSearch();
//
//		// Utiliser offset directement comme CategoriesView (pas de division)
...
//		return ResponseEntity.ok("PersonnelController works!");
//	}
//
//	// Endpoint pour récupérer un personnel par ID
//	@GetMapping("/{id}")
//	public ResponseEntity<PersonnelDTO> getPersonnelById(@PathVariable Long id, Principal principal) {
//		try {
...
//			}
//
//			// Créer un PersonnelDTO avec le personnel trouvé
//			PersonnelDTO response = new PersonnelDTO();
//			response.setRow(personnel);
//			response.setTotal(1);
//			response.setStatus(true);
//			response.setMessage("Personnel trouvé avec succès");
//
//			return ResponseEntity.ok(response);
//		} catch (Exception e) {
//			logger.error("Erreur lors de la récupération du personnel " + id, e);
//			PersonnelDTO errorResponse = new PersonnelDTO();
//			errorResponse.setStatus(false);
//			errorResponse.setMessage("Erreur lors de la récupération du personnel");
...
//	public @ResponseBody Personnel selectPersonnel(@RequestBody com.nectux.mizan.hyban.common.dto.IdRequest req) {
//		return personnelService.findPersonnel(req.getId());
//	}
//
//
//	@ResponseStatus(HttpStatus.OK)
//	@RequestMapping(value = "/choisirpersonnelpret", method = RequestMethod.POST)
//	public @ResponseBody Personnel selectPersonnelpret(@RequestBody com.nectux.mizan.hyban.common.dto.IdRequest req, ModelMap modelmap) {
//		Personnel personne = personnelService.findPersonnel(req.getId());
...
//				 req.getModePaiement(), req.getIdBanque(), req.getNumeroCompte(), req.getNumeroGuichet(), req.getRib(), req.getAncienneteInitial() == null ? 0 : req.getAncienneteInitial(), req.getCarec(), req.getTypeEmp(), req.getTelephone(), req.getSituationMedaille() == null ? 0 : req.getSituationMedaille(), req.getSituationEmploie() , req.getDateRetourcg(), BigDecimal.valueOf(req.getIndemniteRespons()), BigDecimal.valueOf(req.getIndemniteRepresent()), BigDecimal.valueOf(req.getIndemniteTransport()), BigDecimal.valueOf(req.getSursalaire()));
//	}
//
//	@ResponseStatus(HttpStatus.OK)
...
//															@RequestParam(value="situationEmploie", required=false) String situationEmploie,
