...
public interface FormateurRepository extends CrudRepository<Formateur, Long> {
	...
	public Formateur findByIdNotAndNomCompletAndCiviliteAndSexeAndDateNaissanceAndLieuNaissanceAndFixeAndMobileAndCabinetFormationNom(Long id, String nomComplet, String civilite, char sexe, java.util.Date dateNaissance, String lieuNaissance, String fixe, String mobile, String cabinetFormationNom);
	...
	public Page<Formateur> findByAttributes(Pageable pageable,@Param("nomComplet") String nomComplet,
							   ...
							   @Param("sexe") Character sexe,
							   @Param("dateNaissance") java.util.Date dateNaissance,
