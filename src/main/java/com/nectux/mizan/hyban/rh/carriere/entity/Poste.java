...
@Component("poste")
@Scope("prototype")
@Table(name="CGECI_RHPAIE_POSTE")
@SequenceGenerator(name="CGECI_RHPAIE_POSTE_SEQUENCE", sequenceName="CGECI_RHPAIE_POSTE_SEQ", initialValue=1, allocationSize=1)
public class Poste {

	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="CGECI_RHPAIE_POSTE_SEQUENCE")
